  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "history",
        status: "planned",
        note: "Recent activity is on the Overview; filters and paging land in PR 3.",
      },
      {
        label: "Intelligence",
    ...
    items: [
      {
        ...
        icon: "shield",
        status: "planned",
        note: "Needs the audit log surface (PR 3).",
      },
      {
        label: "Sessions",
        href: "/admin/sessions",
      ...
      },
      {
        ...
        icon: "history",
        status: "planned",
        note: "admin_audit_log exists and is append-only; the reader lands in PR 3.",
      },
    ],
  },
  {
