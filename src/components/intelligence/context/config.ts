...
export const CONTEXT_NODES: ContextNodeConfig[] = [
  ...
  },
  {
    ...
    icon: "folder-kanban",
    desktop: { x: 49, y: 8.5, z: -5, dim: 1, blur: 0, bend: -14, line: "front", introAt: 0.5 },
    mobile: { x: 75, y: 7, z: 0, dim: 1, blur: 0, bend: -6, line: "front", introAt: 0.5 },
  },
  {
    id: "goals",
    label: "Goals",
  ...
  },
  {
    ...
    icon: "calendar-clock",
    desktop: { x: 15.5, y: 46.5, z: 10, dim: 1, blur: 0, bend: -10, line: "front", introAt: 0.62 },
    mobile: { x: 75, y: 26, z: 10, dim: 1, blur: 0, bend: -5, line: "none", introAt: 0.62 },
  },
  {
    id: "progress",
    label: "Progress",
    ...
    icon: "trending-up",
    desktop: { x: 84.5, y: 46.5, z: 10, dim: 1, blur: 0, bend: -10, line: "front", introAt: 0.68 },
    mobile: { x: 25, y: 66.5, z: 10, dim: 1, blur: 0, bend: 5, line: "none", introAt: 0.68 },
  },
  {
    id: "dependencies",
    label: "Dependencies",
    ...
    icon: "git-branch",
    desktop: { x: 22.5, y: 78, z: -20, dim: 1, blur: 0, bend: 20, line: "behind", introAt: 0.74 },
    mobile: { x: 75, y: 66.5, z: -20, dim: 1, blur: 0, bend: 5, line: "none", introAt: 0.74 },
  },
  {
    id: "activity",
    label: "Activity",
  ...
  },
  {
    ...
    icon: "layers",
    desktop: { x: 77.5, y: 77, z: -25, dim: 1, blur: 0, bend: 20, line: "behind", introAt: 0.86 },
    mobile: { x: 75, y: 87, z: -25, dim: 1, blur: 0, bend: 6, line: "front", introAt: 0.86 },
  },
];
