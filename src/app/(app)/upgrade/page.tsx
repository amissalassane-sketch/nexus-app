...
export default async function UpgradePage() {
  ...
  return (
    <div className="page-enter mx-auto w-full max-w-[960px]">
        {/* HERO */}
        <div className="text-center">
          <span className="inline-flex h-[22px] items-center rounded-pill border border-lavender-border bg-lavender-subtle px-2.5 eyebrow text-lavender">
            Upgrade
          </span>
          <h1 className="mt-4 text-[26px] font-semibold leading-[32px] tracking-[-0.03em] text-text-primary">
          ...
          {PLAN_ORDER.map((planName) => {
            ...
            return (
              <div
                key={planName}
                className={cn(
                  "flex flex-col rounded-card border bg-bg-subtle p-6",
                  plan.featured
              ...
              >
                ...
                <div className="mt-6 flex-none pt-2">
                  {isCurrent ? (
                    <div className="flex h-9 items-center justify-center rounded-input border border-border-default text-button text-text-secondary">
                      Your current plan
                    </div>
                  ) : isUpgrade ? (
                    ...
                    <div className="flex h-9 items-center justify-center rounded-input border border-border-subtle text-button text-text-tertiary">
