...
export function PrivacySettings() {
  ...
  return <div className="space-y-6">
    ...
    <section className="rounded-card border border-border-default bg-bg-surface p-5 space-y-3"><h2 className="text-lg font-medium">Other data controls</h2>
      ...
      <p className="text-text-secondary">Full account/workspace export, account deletion, objections and restrictions need an operator process. They are not implemented here. A verified controller identity and rights-contact channel must be published before launch; no request has been submitted by this page.</p>
