        ...
        <LandingReveal delay={80}>
          <div className="relative mt-12 overflow-hidden rounded-panel border border-border-subtle bg-bg-subtle/60 px-4 py-10 sm:px-8 sm:py-14">
            ...
            <div className="relative space-y-4 opacity-70" aria-hidden="true">
              <IconRail items={[...firstRow, ...firstRow]} direction={-1} reducedMotion={reducedMotion} />
              <IconRail items={[...secondRow, ...secondRow, ...secondRow]} direction={1} reducedMotion={reducedMotion} />
            </div>
...
function IconRail({ items, direction, reducedMotion }: { items: typeof featured; direction: -1 | 1; reducedMotion: boolean }) {
  return (
